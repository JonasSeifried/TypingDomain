...
export const useAuthStore = defineStore("auth", () => {
  ...
  onAuthStateChanged(auth, async (u) => {
    ...
    const q = query(collection(fireStore, "users"), where("primaryEmail", "==", user.value.email));
  ...
  async function signUp(username: string, email: string, password: string): Promise<Result<void>> {
